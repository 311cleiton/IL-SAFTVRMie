...
full_file_path_msound = ["C:/Users/cleiton/My Drive/usp-brainstorm/bs04/csv/sound/mix_msound.csv"]
full_file_path_T = ["C:/Users/cleiton/My Drive/usp-brainstorm/bs04/csv/sound/mix_T.csv"]
...
exp_data = 11 # experimental datasets (DataFrames)

temperature_model_min = 270 # K
temperature_model_max = 350 # K
...
for i ∈ 1:n_models
    ...
    append!(model_msound,[[s_s[i][1] for i ∈ 1:delta_temperature_model]])
end
#
...
PyPlot.yticks(collect(1300:100:2000))
PyPlot.ylim([1400,1900])
display(PyPlot.gcf())
...
PyPlot.yticks(fontsize=12)
PyPlot.xlim(temperature_model_x_axis)
PyPlot.yticks(collect(1000:100:2000))
PyPlot.ylim([1200,1600])
display(PyPlot.gcf())
#
